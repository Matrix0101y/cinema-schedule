package com.company.cinemaschedule.config;
...
@EnableJpaRepositories(
        basePackages = "com.company.cinemaschedule.data.repository",
...
public class DatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManager() {
        ...
        em.setPackagesToScan("com.company.cinemaschedule.data.entity");
